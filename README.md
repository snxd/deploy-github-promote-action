...
This project is a GitHub Action that uses Solsta tools and services to promote a release from one repository to another, or to the head of a single repository.  
...
```yaml
    ...
    - name: Promote a Release from Dev to QA
      uses: snxd/deploy-github-promote-action@v5
      with:
